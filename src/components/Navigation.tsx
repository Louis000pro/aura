      ...
      {user && (pathname === "/" || pathname === "/progression" || pathname === "/nutrition") && (
        <div className="global-mobile-header md:hidden fixed top-0 left-0 z-40 flex items-center px-3"
          ...
          {/* ⚠️ UN CARRÉ TRÈS ARRONDI A ÉTÉ ESSAYÉ ICI PUIS RETIRÉ LE MÊME JOUR
                ...
                ronds désormais empilés en haut à gauche (le compte, et le
                visage du Guide dans l'entrée de l'accueil) en donnant une
                forme à chacun : cercle au Guide, squircle au compte. À
                l'écran, le squircle ne passe pas. NE PAS REFAIRE
                L'ALLER-RETOUR. Le faux doublon des deux identités reste un
