...
const exerciseData: Record<string, Exercise[]> = {
  "demo-avatars": [
    { name: "Squats",            sets: 3, reps: "12 reps", rest: 60,
      tip: "Pieds à largeur d'épaules. Descends comme pour t'asseoir, talons au sol, dos droit.",
      benefit: "Déclenche l'animation Back Squat — observe la flexion complète des genoux et hanches.",
      muscles: ["Quadriceps", "Fessiers"] },
    { name: "Pompes",            sets: 3, reps: "10 reps", rest: 60,
      tip: "Corps droit de la tête aux talons, coudes à 45°. Descends la poitrine près du sol.",
      benefit: "Déclenche l'animation Push Up — observe le mouvement de poussée au sol.",
      muscles: ["Pectoraux", "Triceps"] },
    { name: "Planche frontale",  sets: 3, reps: "30 sec",  rest: 45, auto: 30,
      tip: "Avant-bras au sol, corps en ligne parfaite. Rentre le nombril, serre les fessiers.",
      benefit: "Déclenche l'animation Plank — le personnage tient la position de gainage.",
      muscles: ["Core"] },
    { name: "Fentes avant",      sets: 3, reps: "12 par jambe", rest: 60,
      tip: "Grand pas, genou arrière à 2 cm du sol. Pousse sur le talon avant pour revenir.",
      benefit: "Déclenche l'animation Situps — mouvement de redressement assis.",
      muscles: ["Quadriceps", "Fessiers"] },
    { name: "Soulevé de terre",  sets: 3, reps: "10 reps", rest: 75,
      tip: "Dos plat, barre contre les tibias. Pousse le sol sous tes pieds, monte les hanches.",
      benefit: "Déclenche l'animation Burpee — mouvement de sol dynamique.",
      muscles: ["Dos", "Lombaires"] },
    { name: "Curl biceps",       sets: 3, reps: "12 reps", rest: 45,
      tip: "Coudes fixes contre le buste. Contracte fort en haut, descends en 3 secondes.",
      benefit: "Déclenche l'animation Jumping Jacks — sauts avec écartement des bras.",
      muscles: ["Biceps"] },
    { name: "Crunch",            sets: 3, reps: "20 reps", rest: 45,
      tip: "Mains derrière les tempes, expire en montant. Soulève les épaules, pas le bas du dos.",
      benefit: "Déclenche l'animation Bicycle Crunch — rotation alternée des coudes.",
      muscles: ["Abdominaux"] },
    { name: "Burpees",           sets: 3, reps: "10 reps", rest: 60,
      tip: "Plonge au sol, pompe, saute — tout en fluidité. Qualité > vitesse.",
      benefit: "Déclenche l'animation Jog In Circle — course fluide en boucle.",
