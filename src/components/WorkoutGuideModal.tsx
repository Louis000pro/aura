...
const exerciseData: Record<string, Exercise[]> = {
  "demo-avatars": [
    ...
    { name: "Jumping Jacks",     sets: 1, reps: "30 sec",  rest: 30, auto: 30,
      ...
      muscles: ["Cardio"] },
    { name: "High Knees",        sets: 1, reps: "30 sec",  rest: 30, auto: 30,
      tip: "Cours sur place en levant les genoux à hauteur des hanches.",
      benefit: "Cardio intense, gainage actif.",
      muscles: ["Cardio", "Core"] },
    { name: "Sprint sur place",  sets: 1, reps: "20 sec",  rest: 30, auto: 20,
      tip: "Cours le plus vite possible sur place. Bras dynamiques.",
      benefit: "Cardio explosif.",
      muscles: ["Cardio"] },
    { name: "Jog en place",      sets: 1, reps: "60 sec",  rest: 30, auto: 60,
      tip: "Cours sur place, rythme tranquille.",
      benefit: "Cardio doux, récup.",
      muscles: ["Cardio"] },
    ...
    { name: "Cross Jumps",       sets: 2, reps: "10 reps", rest: 30,
      tip: "Sauts latéraux croisés, gainage actif.",
      benefit: "Coordination + cardio.",
      muscles: ["Cardio", "Core"] },
    { name: "Cross Jumps Rotation", sets: 2, reps: "10 reps", rest: 30,
      tip: "Comme Cross Jumps mais avec rotation du buste à chaque saut.",
      benefit: "Cardio + obliques.",
      muscles: ["Cardio", "Obliques"] },
    ...
    { name: "Sumo High Pull",    sets: 2, reps: "10 reps", rest: 30,
      tip: "Position sumo, tire la barre jusqu'au menton via les hanches.",
      benefit: "Hip-hinge + tirage haut.",
      muscles: ["Dos", "Trapèzes", "Fessiers"] },

    // ─── Olympic lifts ───────────────────────────────────────
    { name: "Snatch",            sets: 2, reps: "5 reps",  rest: 45,
      tip: "Arraché olympique : barre du sol à au-dessus de la tête en un mouvement.",
      benefit: "Puissance + coordination.",
      muscles: ["Corps entier"] },
