...
const exerciseData: Record<string, Exercise[]> = {
  "demo-avatars": [
    { name: "Air Squat",         sets: 3, reps: "12 reps", rest: 45,
      tip: "Pieds largeur d'épaules, descends comme pour t'asseoir. Talons au sol, dos droit.",
      benefit: "Squat sans matériel — base du bas du corps.",
      muscles: ["Quadriceps", "Fessiers"] },
    { name: "Back Squat",        sets: 3, reps: "10 reps", rest: 75,
      tip: "Barre sur les trapèzes, gainé. Descends sous parallèle, remonte explosif.",
      benefit: "Le roi des exercices — masse et force du bas du corps.",
      muscles: ["Quadriceps", "Fessiers", "Dos"] },
    { name: "Pompes",            sets: 3, reps: "12 reps", rest: 45,
      tip: "Corps droit, coudes à 45°. Descends la poitrine près du sol.",
      benefit: "Polyarticulaire complet du haut du corps.",
      muscles: ["Pectoraux", "Triceps"] },
    { name: "Plank",             sets: 3, reps: "30 sec",  rest: 30, auto: 30,
      tip: "Avant-bras au sol, corps en ligne. Rentre le nombril, serre les fessiers.",
      benefit: "Renforce tout le core profond.",
      muscles: ["Core"] },
    { name: "Sit-ups",           sets: 3, reps: "15 reps", rest: 45,
      tip: "Allongé, genoux fléchis. Monte le buste, expire en montant.",
      benefit: "Ciblage des grands droits de l'abdomen.",
      muscles: ["Abdominaux"] },
    { name: "Bicycle Crunch",    sets: 3, reps: "20 reps", rest: 45,
      tip: "Allongé, jambes en l'air. Coude vers genou opposé en alternance.",
      benefit: "Travaille abdos et obliques en rotation.",
      muscles: ["Abdominaux", "Obliques"] },
    { name: "Burpees",           sets: 3, reps: "10 reps", rest: 60,
      tip: "Plonge au sol, pompe, saute. Qualité > vitesse.",
      benefit: "Brûleur cardio complet, corps entier.",
      muscles: ["Corps entier"] },
    { name: "Jumping Jacks",     sets: 3, reps: "30 sec",  rest: 30, auto: 30,
      tip: "Bras au-dessus et pieds qui s'écartent simultanément. Rythme régulier.",
      benefit: "Cardio rapide à activer, échauffement parfait.",
      muscles: ["Cardio"] },
    { name: "Jog en place",      sets: 1, reps: "60 sec",  rest: 30, auto: 60,
      tip: "Cours sur place, lève bien les genoux, bras qui pompent.",
      benefit: "Cardio doux pour échauffer ou récupérer.",
      muscles: ["Cardio"] },
    { name: "Bicep Curl",        sets: 3, reps: "12 reps", rest: 45,
      tip: "Coudes fixes contre le buste. Contracte en haut 1 sec, descends en 3 sec.",
      benefit: "Isolation des biceps pour masse et définition.",
      muscles: ["Biceps"] },
    { name: "Front Raises",      sets: 3, reps: "12 reps", rest: 45,
      tip: "Bras tendus, lève les haltères devant à hauteur d'épaules. Descends en 3 sec.",
      benefit: "Cible le faisceau antérieur du deltoïde.",
      muscles: ["Épaules"] },
    { name: "Kettlebell Swing",  sets: 3, reps: "15 reps", rest: 60,
      tip: "Hanches en arrière, projette le kettlebell devant via la propulsion des hanches.",
      benefit: "Force explosive de la chaîne postérieure.",
      muscles: ["Fessiers", "Dos", "Core"] },
    { name: "Snatch",            sets: 3, reps: "5 reps",  rest: 90,
      tip: "Arraché olympique : barre du sol à au-dessus de la tête en un mouvement explosif.",
      benefit: "Mouvement complet de puissance — coordination et explosivité.",
      muscles: ["Corps entier"] },
  ],
