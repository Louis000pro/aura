  ...
  return (
    <AnimatePresence>
      {show && (
        ...
        >
          {/* Logo — parfaitement centré (= centre de l'orbe) */}
          <motion.img
            src="/logo-vaiiya.png"
            alt="Vaiiya"
          ...
          {/* Wordmark sous le logo — positionné en absolu pour ne PAS décaler le logo */}
          <motion.span
            className="absolute left-1/2 -translate-x-1/2 text-2xl font-black tracking-tight"
            style={{ top: "calc(50% + 96px)", color: "#2D2150", letterSpacing: "0.04em" }}
