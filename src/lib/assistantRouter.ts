...
const CARTES: Record<string, string> = {
  ...
  plan_ajouter: "une séance à ajouter EN PLUS de ce qui est déjà prévu",
  etape_substituer: "une séance à faire à la place de l’étape que son programme propose",
  etape_sauter: "le passage d’une étape de son programme, avec ce que ça change pour son cycle",
