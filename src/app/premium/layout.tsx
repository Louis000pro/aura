...
export const metadata: Metadata = {
  ...
  title: "Vaiiya+, prix et offre",
  description:
    "Ce que le compte gratuit Vaiiya contient, ce que Vaiiya+ ajoute et combien il coûte. L’abonnement n’est pas encore ouvert à la souscription.",
